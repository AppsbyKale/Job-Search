...
fun AddJobScreen(
    ...
    val isEditing = state.jobId != null || jobId != null
    val titleText = if (isEditing) "Edit job" else stringResource(R.string.add_job_title)
            ...
            if (!isEditing) {
                ...
                item {
                    Button(
                        ...
                        Text(if (state.saving) stringResource(R.string.saving_label) else stringResource(R.string.save_generate_button))
                    }
                }
                ...
                item {
                    OutlinedButton(
                        ...
                        Text(stringResource(R.string.save_without_generating_button))
                    }
                }
                ...
                item {
                    Button(
                        ...
                        Text(if (state.saving) stringResource(R.string.saving_label) else stringResource(R.string.save_button))
                    }
                }
            }
        }
